...
class date_data_remote(data):
    def __init__(self):
        ...
        date_data_remote.__sp_lookup_date = sp_list["lookup_date"]
        ...
        date_data_remote.__sp_truncate_tables = sp_list["truncate_table"]
        date_data_remote.__sp_get_dates = sp_list["get_dates"]
    ...
    def lookup_date(self, date, description):      
        # convert date into correct format
        date_str = data._convert_date(date)
        args = (str(date_str), str(description))
